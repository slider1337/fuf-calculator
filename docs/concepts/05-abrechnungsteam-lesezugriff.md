...
Die Rolle ist **je Reise** zu vergeben; auf Gruppenebene kann später auch ein Standard-Abrechnungsteam als Vorlage hinterlegt werden, wenn das wirklich wiederkehrt. Zunächst je Reise wählen, denn Jahresabrechnungen und Zuständigkeiten können wechseln. Die Orga sieht die Abrechnungsdaten automatisch und darf Belege freigeben; das Abrechnungsteam darf nur lesen. Bei einer Person mit beiden Rollen gilt die Orga-Zuordnung ausdrücklich als Grund für weitergehende Rechte.
...
- Historische Abrechnungsstände/Audit bleiben nachvollziehbar. Der neue Reisestatus `abgerechnet` sperrt Schreibwege, die Summen verändern könnten, unabhängig davon, ob sie aus der Oberfläche oder direkt über die API kommen.
